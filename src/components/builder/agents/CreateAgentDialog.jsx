...
export default function CreateAgentDialog({ open, onOpenChange, appId, onSuccess }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="instructions"
                placeholder="Give detailed instructions on how the agent should behave, its tone, and what it should help with..."
                value={formData.instructions}
                onChange={(e) => setFormData({ ...formData, instructions: e.target.value })}
                className="backdrop-blur-sm bg-white/50 border-white/40 h-32"
              />
              <p className="text-xs text-gray-600">
                Be specific about the agent's role, personality, and how it should respond to users
              </p>
            </div>
